...
/* ═══════════ PIAZZE ═══════════ */
#pzOv{position:fixed;inset:0;z-index:8900;background:var(--bg);
display:flex;flex-direction:column;overflow:hidden;
animation:pzIn .3s var(--e-soft) both;}
@keyframes pzIn{from{opacity:0;transform:translateY(14px)}to{opacity:1;transform:none}}
body.pz-aperto{overflow:hidden;}
.pz-hd{position:relative;padding:18px 54px 14px;text-align:center;
background:var(--card);border-bottom:1.5px solid var(--bd);flex-shrink:0;}
.pz-x{position:absolute;left:12px;top:14px;width:36px;height:36px;
border:1.5px solid var(--bd);border-radius:var(--r-row);background:var(--fill3);
color:var(--tx);font-size:17px;font-weight:750;cursor:pointer;}
.pz-ti{font-size:17px;font-weight:850;letter-spacing:-.02em;line-height:1.2;}
.pz-su{font-size:12px;font-weight:600;color:var(--mu);margin-top:3px;}
.pz-modi{display:flex;gap:6px;justify-content:center;margin-top:11px;}
...
.pz-tile b{font-size:21px;font-weight:850;line-height:1;}
.pz-tile span{font-size:10px;font-weight:750;color:var(--mu);text-transform:uppercase;letter-spacing:.04em;}
.pz-cerca input{width:100%;padding:12px 15px;border:1.5px solid var(--bd);
border-radius:var(--r-row);background:var(--card);color:var(--tx);font-size:14px;
font-weight:600;outline:none;}
.pz-add{width:100%;margin:11px 0;padding:12px;border:1.5px dashed var(--bd);
border-radius:var(--r-row);background:transparent;color:var(--a);
font-size:13px;font-weight:750;cursor:pointer;}
.pz-list{display:flex;flex-direction:column;gap:7px;}
.pz-row{display:flex;align-items:center;gap:11px;width:100%;padding:12px 14px;
border:1.5px solid var(--bd);border-radius:var(--r-row);background:var(--card);
cursor:pointer;text-align:left;}
.pz-dot{width:10px;height:10px;border-radius:50%;flex-shrink:0;background:var(--mu);}
.pz-ok .pz-dot{background:var(--ok);}
.pz-scaduta .pz-dot{background:var(--err);}
.pz-mai .pz-dot{background:var(--fill1);border:2px solid var(--bd);}
.pz-nm{flex:1;min-width:0;display:flex;flex-direction:column;gap:2px;}
.pz-nm b{font-size:14px;font-weight:750;line-height:1.25;}
.pz-nm i{font-size:11px;font-weight:600;color:var(--mu);font-style:normal;}
.pz-ar{font-size:17px;color:var(--mu);opacity:.4;flex-shrink:0;font-weight:600;}
.pz-vuoto,.pz-nota{padding:22px 10px;text-align:center;font-size:13px;
font-weight:600;color:var(--mu);line-height:1.5;}
.pz-nota{padding:10px 4px 14px;}

/* la linea della metropolitana */
.pz-linea{padding:18px 16px 24px;}
.mx-wrap{position:relative;padding-left:6px;}
.mx-cap{display:flex;align-items:center;gap:14px;padding:6px 0 18px;position:relative;}
.mx-big{width:26px;height:26px;border-radius:50%;background:var(--a);flex-shrink:0;
border:4px solid var(--card);box-shadow:0 0 0 3px var(--a);z-index:2;}
.mx-cap .mx-tx b{font-size:17px;font-weight:850;}
.mx-cap .mx-tx i{display:block;font-size:11px;color:var(--mu);font-style:normal;font-weight:600;margin-top:2px;}
.mx-st{display:flex;align-items:center;gap:14px;padding:10px 0;position:relative;cursor:pointer;}
.mx-st::before{content:'';position:absolute;left:12px;top:-10px;bottom:50%;
width:3px;background:var(--a);opacity:.45;}
.mx-st:last-child::after{content:'';position:absolute;left:12px;top:50%;bottom:0;
width:3px;background:var(--bg);}
.mx-d{width:14px;height:14px;border-radius:50%;background:var(--card);
border:3px solid var(--a);flex-shrink:0;margin-left:5px;z-index:2;position:relative;
transition:transform var(--d2) var(--e-spring),background var(--d2) var(--e-smooth);}
.mx-st.att .mx-d{background:var(--a);transform:scale(1.35);}
.mx-n{font-size:10px;font-weight:850;color:var(--mu);width:18px;flex-shrink:0;
font-variant-numeric:tabular-nums;}
.mx-st .mx-tx{flex:1;min-width:0;}
.mx-st .mx-tx b{font-size:14px;font-weight:750;line-height:1.3;}
.mx-st .mx-tx i{font-style:normal;font-size:12px;margin-left:6px;}
.mx-st.att .mx-tx b{color:var(--a);font-weight:850;}
.mx-st.nas .mx-tx b{color:var(--mu);}
.mx-q{letter-spacing:.14em;opacity:.55;}
.mx-st.nas .mx-d{border-color:var(--bd);}

.pz-foot{display:flex;gap:9px;padding:12px 16px;background:var(--card);
border-top:1.5px solid var(--bd);flex-shrink:0;}
.pz-nav{width:62px;height:48px;border:1.5px solid var(--bd);border-radius:var(--r-row);
background:var(--fill3);color:var(--tx);font-size:17px;font-weight:750;cursor:pointer;}
.pz-next{background:var(--a);border-color:var(--a);color:#fff;}
.pz-tutte{flex:1;height:48px;border:1.5px solid var(--bd);border-radius:var(--r-row);
background:var(--card);color:var(--tx);font-size:13px;font-weight:750;cursor:pointer;}
.pz-foot2{gap:9px;}
.pz-si,.pz-no{flex:1;height:48px;border:none;border-radius:var(--r-row);
font-size:14px;font-weight:800;cursor:pointer;color:#fff;}
.pz-si{background:var(--ok);}
.pz-no{background:var(--err);}
.pz-azioni{display:flex;gap:8px;padding:10px 16px 16px;background:var(--card);flex-shrink:0;}
.pz-azioni button{flex:1;padding:11px 6px;border:1.5px solid var(--bd);
border-radius:var(--r-row);background:var(--fill3);color:var(--tx);
font-size:12px;font-weight:750;cursor:pointer;}

/* verifica */
.pz-ver{display:flex;flex-direction:column;align-items:center;justify-content:center;
gap:16px;min-height:52vh;text-align:center;}
.ver-q{font-size:14px;font-weight:600;color:var(--mu);}
.ver-n{width:76px;height:76px;border-radius:50%;background:var(--a);color:#fff;
display:flex;align-items:center;justify-content:center;font-size:34px;font-weight:850;}
.ver-r b{font-size:21px;font-weight:850;line-height:1.3;}
.pz-fine{display:flex;flex-direction:column;align-items:center;gap:12px;
padding-top:26px;text-align:center;}
.fin-n{font-size:40px;font-weight:850;line-height:1;}
.fin-n.ok{color:var(--ok);}
.fin-n.mid{color:var(--warn);}
.fin-n.ko{color:var(--err);}
.fin-s{font-size:14px;font-weight:600;color:var(--mu);}
.fin-t{font-size:12px;font-weight:750;color:var(--mu);margin-top:10px;
text-transform:uppercase;letter-spacing:.04em;}
.fin-l{display:flex;flex-wrap:wrap;gap:7px;justify-content:center;padding:0 8px;}
.fin-l span{padding:7px 12px;border-radius:var(--r-pill);background:rgba(229,72,77,.12);
color:var(--err);font-size:12px;font-weight:750;}

/* pannello sulla mappa */
#pzPan{position:fixed;right:12px;top:76px;bottom:88px;width:310px;max-width:80vw;
z-index:6400;background:color-mix(in srgb,var(--card) 95%,transparent);
backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);
border:1.5px solid var(--bd);border-radius:var(--r-card);box-shadow:var(--sh-xl);
display:flex;flex-direction:column;overflow:hidden;}
.pzp-hd{display:flex;align-items:center;justify-content:space-between;gap:8px;
padding:12px 14px;border-bottom:1.5px solid var(--sep2);}
.pzp-hd b{font-size:14px;font-weight:850;line-height:1.25;}
.pzp-hd button{width:30px;height:30px;flex-shrink:0;border:1.5px solid var(--bd);
border-radius:var(--r-pill);background:var(--fill3);color:var(--tx);cursor:pointer;}
.pzp-hint{padding:9px 14px;font-size:11px;font-weight:600;color:var(--mu);
background:var(--fill3);line-height:1.4;}
.pzp-list{flex:1;overflow-y:auto;padding:8px;display:flex;flex-direction:column;gap:5px;}
.pzp-row{display:flex;align-items:center;gap:9px;width:100%;padding:9px 11px;
border:1.5px solid var(--bd);border-radius:var(--r-row);background:var(--card);
cursor:pointer;text-align:left;font-size:12.5px;}
.pzp-row b{flex:1;min-width:0;font-weight:700;line-height:1.3;}
.pzp-row i{font-style:normal;flex-shrink:0;font-size:13px;}
.pzp-row.att{border-color:var(--a);background:rgba(36,71,214,.08);}
.pzp-cap{background:rgba(36,71,214,.06);}
.pzp-d{width:12px;height:12px;border-radius:50%;background:var(--a);flex-shrink:0;}
.pzp-n{width:19px;font-size:10px;font-weight:850;color:var(--mu);flex-shrink:0;text-align:center;}
@media (max-width:760px){
#pzPan{left:10px;right:10px;width:auto;max-width:none;top:auto;bottom:10px;height:46vh;}
}
/* marker delle piazze */
.pz-pin{background:var(--a);border:2.5px solid #fff;border-radius:50%;
...
/* ══════════ NORME ══════════ */
#nmOv{position:fixed;inset:0;z-index:8900;background:var(--bg);
display:flex;flex-direction:column;overflow:hidden;
animation:pzIn .3s var(--e-soft) both;}
.nm-hd{position:relative;padding:18px 54px 14px;text-align:center;flex-shrink:0;
border-bottom:1.5px solid var(--sep2);background:var(--card);}
.nm-x{position:absolute;left:14px;top:14px;width:36px;height:36px;border:none;
border-radius:var(--r-row);background:var(--fill2);color:var(--tx);
font-size:17px;font-weight:750;cursor:pointer;}
.nm-ti{font-size:17px;font-weight:850;letter-spacing:-.02em;color:var(--tx);}
.nm-su{font-size:12px;color:var(--mu);font-weight:650;margin-top:2px;}
.nm-body{flex:1;display:block;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:14px 16px 24px;}
#nmOv .nm-body>*{max-width:var(--card-w,560px);margin-left:auto;margin-right:auto;}
.nm-tiles{display:flex;gap:9px;margin-bottom:13px;}
.nm-tile{flex:1;padding:12px 8px;background:var(--card);border:1.5px solid var(--bd);
border-radius:var(--r-row);text-align:center;}
.nm-tile b{display:block;font-size:21px;font-weight:850;color:var(--a);
font-variant-numeric:tabular-nums;line-height:1;}
.nm-tile small{display:block;font-size:10px;font-weight:800;color:var(--mu);
letter-spacing:.04em;margin-top:5px;}
.nm-go,.nm-go2{display:block;width:100%;padding:14px;margin-bottom:9px;
border-radius:var(--r-act);font-size:15px;font-weight:850;cursor:pointer;font-family:inherit;}
.nm-go{border:none;background:var(--a);color:#fff;}
.nm-go2{border:1.5px solid var(--bd);background:var(--card);color:var(--tx);font-size:14px;}
.nm-go:active,.nm-go2:active{transform:scale(.97);}
.nm-lab{font-size:10px;font-weight:850;color:var(--mu);letter-spacing:.06em;
margin:16px 0 8px;}
.nm-list{display:flex;flex-direction:column;gap:7px;}
.nm-row{display:flex;align-items:center;gap:9px;width:100%;padding:12px 13px;
border:1.5px solid var(--bd);border-left-width:3px;border-radius:var(--r-row);
background:var(--card);text-align:left;cursor:pointer;}
.nm-row.ok{border-left-color:var(--ok);} .nm-row.mid{border-left-color:var(--warn);}
.nm-row.ko,.nm-row.scad{border-left-color:var(--err);} .nm-row.mai{border-left-color:var(--bd);}
.nm-art{flex-shrink:0;font-size:10px;font-weight:850;color:var(--a);
background:rgba(36,71,214,.1);padding:4px 7px;border-radius:var(--r-pill);}
.nm-t{flex:1;font-size:13px;font-weight:750;color:var(--tx);line-height:1.3;}
.nm-m{font-size:11px;color:var(--mu);font-weight:650;flex-shrink:0;}
.nm-m b{color:var(--err);font-weight:850;}
.nm-ar{font-size:15px;color:var(--mu);opacity:.35;flex-shrink:0;}
.nm-punti{display:flex;flex-direction:column;gap:10px;margin-bottom:16px;}
.nm-p{display:flex;gap:11px;padding:13px;background:var(--card);
border:1.5px solid var(--bd);border-radius:var(--r-row);
font-size:14px;font-weight:600;color:var(--tx);line-height:1.5;}
.nm-n{flex-shrink:0;width:22px;height:22px;border-radius:50%;background:var(--a);
color:#fff;font-size:11px;font-weight:850;display:flex;align-items:center;
justify-content:center;margin-top:1px;}
.nm-nums{display:flex;flex-direction:column;gap:8px;}
.nm-num{display:flex;align-items:center;gap:13px;padding:13px;background:var(--card);
border:1.5px solid var(--bd);border-radius:var(--r-row);}
.nm-num b{flex-shrink:0;min-width:92px;font-size:17px;font-weight:850;color:var(--a);
font-variant-numeric:tabular-nums;}
.nm-num span{font-size:13px;color:var(--tx);font-weight:600;line-height:1.4;}
.nm-cls{margin-bottom:11px;padding:14px;background:var(--card);
border:1.5px solid var(--bd);border-left-width:4px;border-radius:var(--r-row);}
.nm-cls.c1{border-left-color:var(--ok);} .nm-cls.c2{border-left-color:var(--warn);}
.nm-cls.c3{border-left-color:#E8833A;} .nm-cls.c4{border-left-color:var(--err);}
.nm-ch{display:flex;align-items:baseline;gap:9px;margin-bottom:9px;}
.nm-ch b{font-size:15px;font-weight:850;color:var(--tx);}
.nm-ch span{font-size:12px;font-weight:750;color:var(--mu);}
.nm-cls ul{margin:0;padding-left:18px;}
.nm-cls li{font-size:13px;color:var(--tx);font-weight:600;line-height:1.55;margin-bottom:3px;}
.nm-bar{height:5px;background:var(--fill3);border-radius:var(--r-pill);
overflow:hidden;margin-bottom:18px;}
.nm-bar i{display:block;height:100%;background:var(--a);border-radius:var(--r-pill);
transition:width var(--d2) var(--e-smooth);}
.nm-q{font-size:17px;font-weight:750;color:var(--tx);line-height:1.45;margin-bottom:18px;}
.nm-opz{display:flex;flex-direction:column;gap:9px;}
.nm-o{padding:14px;border:1.5px solid var(--bd);border-radius:var(--r-act);
background:var(--card);color:var(--tx);font-size:14px;font-weight:650;
text-align:left;cursor:pointer;font-family:inherit;line-height:1.4;
transition:all var(--d1) var(--e-smooth);}
.nm-o:active{transform:scale(.98);}
.nm-o.good{background:rgba(14,159,110,.14);border-color:var(--ok);color:var(--ok);font-weight:850;}
.nm-o.bad{background:rgba(229,72,77,.12);border-color:var(--err);color:var(--err);}
.nm-art2{margin-top:16px;text-align:center;font-size:11px;color:var(--mu);font-weight:750;}
.nm-fin{text-align:center;padding:18px 0;}
.nm-perc{font-size:40px;font-weight:850;letter-spacing:-.04em;line-height:1;
font-variant-numeric:tabular-nums;}
.nm-perc.ok{color:var(--ok);} .nm-perc.mid{color:var(--warn);} .nm-perc.ko{color:var(--err);}
.nm-sub{font-size:14px;color:var(--mu);font-weight:650;margin-top:7px;margin-bottom:18px;}
.nm-rev{text-align:left;margin-bottom:18px;}
.nm-rev>b{display:block;font-size:10px;font-weight:850;color:var(--mu);
letter-spacing:.06em;margin-bottom:9px;}
.nm-rv{padding:11px 13px;background:var(--fill3);border-radius:var(--r-row);margin-bottom:7px;}
.nm-ra{display:inline-block;font-size:10px;font-weight:850;color:var(--a);
background:rgba(36,71,214,.1);padding:3px 6px;border-radius:var(--r-pill);margin-bottom:6px;}
.nm-rv i{display:block;font-style:normal;font-size:13px;font-weight:650;
color:var(--tx);line-height:1.4;margin-bottom:5px;}
.nm-rv em{display:block;font-style:normal;font-size:13px;font-weight:850;color:var(--ok);}


/* ══════════ MAPPA PIAZZE — stessa faccia dei percorsi ══════════ */
#pzMapOv{position:fixed;inset:0;z-index:8950;background:var(--bg);
display:flex;flex-direction:column;overflow:hidden;
animation:pzIn .28s var(--e-soft) both;}
.pzm-top{display:flex;align-items:center;gap:9px;padding:10px 12px;flex-shrink:0;
background:var(--card);border-bottom:1.5px solid var(--sep2);}
.pzm-home,.pzm-dado{width:38px;height:38px;flex-shrink:0;border:1.5px solid var(--bd);
border-radius:var(--r-row);background:var(--bg);color:var(--tx);
...
background:var(--fill3);color:var(--mu);font-size:13px;font-weight:750;
cursor:pointer;font-family:inherit;min-height:36px;}
.pzm-seg button.on{background:var(--card);color:var(--tx);box-shadow:var(--sh-sm);}
.pzm-seg .pzm-geo{flex:0 0 46px;background:var(--acc);color:#fff;font-size:15px;}
.pzm-wrap{flex:1;min-height:0;display:flex;flex-direction:column;position:relative;}
.pzm-map{flex:1;min-height:0;position:relative;}
#pzMapEl{position:absolute;inset:0;}
#pzMapOv .pzm-panel{position:relative;flex-shrink:0;max-height:44vh;
display:flex;flex-direction:column;background:var(--card);
border-top:1.5px solid var(--sep2);border-radius:0;box-shadow:none;
inset:auto;width:auto;height:auto;transform:none;}
#pzMapOv .pzm-panel .steps{overflow-y:auto;-webkit-overflow-scrolling:touch;
padding:8px 12px;display:flex;flex-direction:column;gap:5px;flex:1;min-height:0;}
#pzMapOv .step{display:flex;align-items:center;gap:10px;width:100%;padding:9px 11px;
border:1.5px solid var(--bd);border-radius:var(--r-row);background:var(--bg);
text-align:left;cursor:pointer;font-family:inherit;}
#pzMapOv .step.cur{border-color:var(--a);background:rgba(36,71,214,.08);}
#pzMapOv .step.att{border-color:var(--acc);border-width:2px;}
#pzMapOv .step.cap{border-color:var(--a);border-width:2px;}
#pzMapOv .sn{flex-shrink:0;width:23px;height:23px;border-radius:50%;
background:var(--fill2);color:var(--tx);font-size:11px;font-weight:850;
display:flex;align-items:center;justify-content:center;}
#pzMapOv .step.fatta .sn{background:var(--a);color:#fff;}
#pzMapOv .sn.cap{background:var(--a);color:#fff;}
#pzMapOv .sv{flex:1;min-width:0;font-size:13px;font-weight:700;color:var(--tx);line-height:1.3;}
#pzMapOv .sp{flex-shrink:0;font-size:12px;opacity:.75;}
#pzMapOv .phead{padding:11px 14px 9px;flex-shrink:0;}
#pzMapOv .pfoot{padding:9px 12px calc(9px + env(safe-area-inset-bottom));flex-shrink:0;}
.pz-rnd{position:absolute;right:14px;top:14px;width:36px;height:36px;border:none;
border-radius:var(--r-row);background:var(--acc);color:#fff;font-size:17px;cursor:pointer;}
.pz-rnd:active{transform:scale(.92) rotate(18deg);}
@media(min-width:780px){
.pzm-wrap{flex-direction:row;}
...
/* ══════════ SCRIVI LE VIE ══════════ */
#scOv{position:fixed;inset:0;z-index:8960;background:var(--bg);
display:flex;flex-direction:column;overflow:hidden;
animation:pzIn .28s var(--e-soft) both;}
.sc-hd{position:relative;padding:14px 54px 11px;text-align:center;flex-shrink:0;
background:var(--card);border-bottom:1.5px solid var(--sep2);}
...
.sc-bar{height:5px;background:var(--fill3);flex-shrink:0;}
.sc-bar i{display:block;height:100%;background:var(--ok);
transition:width var(--d2) var(--e-smooth);}
.sc-wrap{flex:1;min-height:0;display:flex;flex-direction:column;}
.sc-mappa{position:relative;height:34%;min-height:150px;flex-shrink:0;}
#scMapEl{position:absolute;inset:0;}
.sc-badge{position:absolute;right:10px;top:10px;z-index:900;
padding:6px 11px;border-radius:var(--r-pill);
background:color-mix(in srgb,var(--card) 92%,transparent);
font-size:12px;font-weight:850;color:var(--tx);box-shadow:var(--sh-sm);
font-variant-numeric:tabular-nums;}
.sc-lato{flex:1;min-height:0;overflow-y:auto;-webkit-overflow-scrolling:touch;
padding:10px 14px;background:var(--bg);}
.sc-slots{display:flex;flex-direction:column;gap:6px;
max-width:var(--card-w,560px);margin:0 auto;}
.sc-slot{display:flex;align-items:center;gap:10px;padding:10px 12px;
border:1.5px dashed var(--bd);border-radius:var(--r-row);background:var(--card);}
.sc-slot.ok{border-style:solid;border-color:var(--ok);
background:color-mix(in srgb,var(--ok) 8%,var(--card));}
.sc-n{flex-shrink:0;width:23px;height:23px;border-radius:50%;background:var(--fill2);
color:var(--mu);font-size:11px;font-weight:850;display:flex;
align-items:center;justify-content:center;}
.sc-slot.ok .sc-n{background:var(--ok);color:#fff;}
.sc-v{flex:1;font-size:14px;font-weight:750;color:var(--mu);line-height:1.3;}
.sc-slot.ok .sc-v{color:var(--tx);}
.sc-q,.sc-h{flex-shrink:0;font-size:12px;font-weight:850;color:var(--warn);}
.sc-foot{display:flex;gap:8px;flex-shrink:0;padding:10px 12px calc(10px + env(safe-area-inset-bottom));
background:var(--card);border-top:1.5px solid var(--sep2);}
#scIn{flex:1;min-width:0;padding:13px 15px;border:1.5px solid var(--bd);
border-radius:var(--r-act);background:var(--bg);color:var(--tx);
font-size:16px;font-weight:650;font-family:inherit;outline:none;}
#scIn:focus{border-color:var(--a);box-shadow:0 0 0 3px rgba(36,71,214,.12);}
.sc-ok,.sc-aiuto{width:50px;flex-shrink:0;border:none;border-radius:var(--r-act);
font-size:18px;cursor:pointer;font-family:inherit;}
.sc-ok{background:var(--a);color:#fff;font-weight:850;}
.sc-aiuto{background:var(--fill2);color:var(--tx);}
.sc-ok:active,.sc-aiuto:active{transform:scale(.93);}
.sc-esito{position:fixed;left:50%;transform:translateX(-50%);
bottom:calc(76px + env(safe-area-inset-bottom));z-index:9100;
padding:11px 18px;border-radius:var(--r-pill);font-size:14px;font-weight:800;
box-shadow:var(--sh-md);opacity:0;transition:opacity var(--d2) var(--e-smooth);
max-width:90vw;text-align:center;pointer-events:none;}
.sc-esito.ok{background:var(--ok);color:#fff;}
.sc-esito.ko{background:var(--err);color:#fff;}
.sc-esito.info{background:var(--card);color:var(--tx);border:1.5px solid var(--bd);}
.pz-pin-ok{background:var(--ok)!important;border-color:var(--ok)!important;}
.sc-fin{flex:1;overflow-y:auto;padding:26px 18px;text-align:center;
max-width:var(--card-w,560px);margin:0 auto;width:100%;}
.sc-tick{width:66px;height:66px;margin:0 auto 14px;border-radius:50%;
background:var(--ok);color:#fff;font-size:34px;font-weight:850;
display:flex;align-items:center;justify-content:center;}
.sc-tit{font-size:21px;font-weight:850;letter-spacing:-.02em;margin-bottom:20px;}
.sc-riga{display:flex;align-items:baseline;gap:11px;padding:11px 14px;
background:var(--card);border:1.5px solid var(--bd);border-radius:var(--r-row);
margin-bottom:7px;text-align:left;}
.sc-riga b{min-width:62px;font-size:19px;font-weight:850;color:var(--a);
font-variant-numeric:tabular-nums;}
.sc-riga span{font-size:13px;color:var(--mu);font-weight:650;}
.sc-go,.sc-go2{display:block;width:100%;padding:14px;margin-top:9px;
border-radius:var(--r-act);font-size:15px;font-weight:850;cursor:pointer;font-family:inherit;}
.sc-go{border:none;background:var(--a);color:#fff;}
.sc-go2{border:1.5px solid var(--bd);background:var(--card);color:var(--tx);font-size:14px;}
.pz-primario.pz-sec{background:var(--card);color:var(--a);
border:1.5px solid var(--a);box-shadow:none;}
@media(min-width:780px){
.sc-wrap{flex-direction:row;}
.sc-mappa{height:auto;width:58%;min-height:0;}
.sc-lato{width:42%;}
}

#pzOv .pz-azioni .pz-del{color:var(--err);border-color:rgba(229,72,77,.35);}


/* ══════════ PIAZZE · redesign ══════════ */
.pz-prog{padding:14px;background:var(--card);border:1.5px solid var(--bd);
border-radius:var(--r-card);}
.pz-prog-t{display:flex;align-items:baseline;justify-content:space-between;margin-bottom:9px;}
.pz-prog-t b{font-size:15px;font-weight:850;color:var(--tx);}
.pz-prog-t i{font-style:normal;font-size:21px;font-weight:850;color:var(--a);
font-variant-numeric:tabular-nums;}
.pz-prog-b{height:8px;background:var(--fill3);border-radius:var(--r-pill);overflow:hidden;}
.pz-prog-b span{display:block;height:100%;background:var(--a);border-radius:var(--r-pill);
transition:width var(--d3) var(--e-smooth);}
.pz-prog-s{display:flex;gap:7px;margin-top:11px;}
.pz-prog-s button{flex:1;padding:8px 6px;border:1.5px solid var(--bd);
border-radius:var(--r-row);background:var(--bg);color:var(--mu);
font-size:11px;font-weight:750;cursor:pointer;font-family:inherit;line-height:1.25;}
.pz-prog-s button:active{transform:scale(.95);}
.pz-grp{font-size:10px;font-weight:850;color:var(--mu);letter-spacing:.07em;
margin:16px 0 8px;display:flex;align-items:center;gap:7px;}
.pz-grp:first-child{margin-top:4px;}
.pz-grp em{font-style:normal;font-size:10px;font-weight:850;color:var(--a);
background:rgba(36,71,214,.1);padding:2px 7px;border-radius:var(--r-pill);}
.pz-modi4{display:flex;gap:4px;padding:5px;margin:10px auto 0;background:var(--fill3);
border-radius:var(--r-row);max-width:var(--card-w,560px);}
.pz-modi4 .pz-m{flex:1;padding:9px 4px;border:none;border-radius:var(--r-pill);
background:transparent;color:var(--mu);font-size:12px;font-weight:750;
cursor:pointer;font-family:inherit;min-height:36px;}
.pz-modi4 .pz-m.on{background:var(--card);color:var(--tx);box-shadow:var(--sh-sm);}
.pz-modi4 .pz-m:active{transform:scale(.95);}
#pzOv .pz-dot{width:11px;height:11px;border-radius:50%;flex-shrink:0;background:var(--bd);}
#pzOv .pz-row.pz-scaduta{border-left:3px solid var(--err);}
#pzOv .pz-row.pz-corso{border-left:3px solid var(--warn);}
#pzOv .pz-row.pz-ok{border-left:3px solid var(--ok);}
#pzOv .pz-row.pz-mai{border-left:3px solid var(--bd);}
...
#mgCanvas{position:absolute;inset:0;z-index:650;pointer-events:none;}
...
/* ══════════ PAGINE SEZIONE ══════════ */
#scnOv{position:fixed;top:0;left:0;right:0;
bottom:calc(var(--tabh,64px) + env(safe-area-inset-bottom));
z-index:2700;background:var(--ios-bg);display:flex;flex-direction:column;overflow:hidden;
...
white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
.sc-d{flex-shrink:0;font-size:17px;color:var(--ios-lbl2);letter-spacing:-.43px;
font-variant-numeric:tabular-nums;}
.sc-nota{font-size:13px;color:var(--ios-lbl2);margin:0 32px 10px;line-height:1.4;}
.sc-vuoto{text-align:center;font-size:15px;color:var(--ios-lbl2);padding:40px 24px;}


/* ══════════ FASE 4 · PULIZIA ══════════
   tutto quello che stava nel menu ⋯ ora vive nel Profilo o nelle
   pagine sezione: il menu e i bottoni doppi spariscono. Nascosti
   e non cancellati, perche' il nucleo li cerca ancora per id. */
button.ichip[onclick="togMenu()"],#omenu,.omenu{display:none!important;}
button.ichip[onclick="openAdd()"]{display:none!important;}
#pzBtnTopo{display:none!important;}
#svBtn{display:none!important;}
#homeScreen.hm-stat .plan-exam{display:none!important;}


/* ══════════ PANNELLO RIDOTTO SU IPHONE ══════════ */
#panel.pnl-mini #lineaBtn,#panel.pnl-mini #rifBox,#panel.pnl-mini #sList,
#panel.pnl-mini .snap-ticks{display:none!important;}
#panel.pnl-mini{overflow:hidden;}


/* ══════════ CORREGGI LE TAPPE ══════════ */
#edOv{position:fixed;inset:0;z-index:9350;background:var(--ios-bg);
display:flex;flex-direction:column;overflow:hidden;
transform:translateY(100%);transition:transform .45s var(--ios-spring);
font-family:-apple-system,BlinkMacSystemFont,'SF Pro Text','Helvetica Neue',sans-serif;
border-radius:12px 12px 0 0;}
#edOv.su{transform:none;}
.ed-nav{display:flex;align-items:center;justify-content:space-between;flex-shrink:0;
padding:calc(12px + env(safe-area-inset-top,0px)) 8px 10px;
border-bottom:.5px solid var(--ios-sep);
background:color-mix(in srgb,var(--ios-bg) 92%,transparent);}
.ed-a,.ed-s{border:none;background:transparent;color:var(--ios-blue);font-family:inherit;
font-size:17px;letter-spacing:-.4px;padding:8px 10px;min-height:44px;cursor:pointer;}
.ed-s{font-weight:600;}
.ed-a:active,.ed-s:active{opacity:.4;}
.ed-t{font-size:17px;font-weight:600;color:var(--ios-lbl);letter-spacing:-.4px;}
.ed-body{flex:1;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:22px 0 60px;}
.ed-body>*{max-width:680px;margin-left:auto;margin-right:auto;}
.ed-gr{padding:0;}
.ed-in{flex:1;min-width:0;border:none;background:transparent;color:var(--ios-lbl);
font-family:inherit;font-size:17px;letter-spacing:-.43px;padding:11px 0;outline:none;}
.ed-tit{display:block;width:100%;box-sizing:border-box;padding:11px 16px;font-weight:600;}
.ed-r{display:flex;align-items:center;gap:6px;min-height:44px;padding:0 8px 0 12px;position:relative;}
.ed-r+.ed-r::before{content:'';position:absolute;top:0;left:44px;right:0;height:.5px;background:var(--ios-sep);}
.ed-n{flex:0 0 26px;font-size:15px;font-weight:600;color:var(--ios-lbl2);
font-variant-numeric:tabular-nums;text-align:right;margin-right:6px;}
.ed-b{flex:0 0 34px;width:34px;height:34px;border:none;border-radius:50%;
background:var(--ios-gray6,#F2F2F7);color:var(--ios-blue);font-size:16px;font-weight:600;
cursor:pointer;display:flex;align-items:center;justify-content:center;font-family:inherit;}
.dark .ed-b{background:#2C2C2E;}
.ed-b:disabled{opacity:.25;cursor:default;}
.ed-b:active:not(:disabled){background:var(--ios-hl);}
.ed-x{color:#fff;background:var(--ios-red)!important;font-size:20px;}
.ed-add{display:block;width:calc(100% - 32px);margin:0 16px 16px;min-height:44px;padding:11px;
border:none;border-radius:10px;background:var(--ios-card);color:var(--ios-blue);
font-family:inherit;font-size:17px;letter-spacing:-.4px;cursor:pointer;text-align:left;}
...
.sc-r .pf-txt.sc-txt{min-height:62px;padding-top:10px;padding-bottom:10px;align-items:center;}
.sc-col{justify-content:center;gap:2px;}
.sc-col .pf-n{line-height:1.25;}
.sc-s{line-height:1.3;}


/* ══════════ FASE 2 · UN TEMA SOLO, STILE APP QUIZ ══════════
   le variabili --ios-* restano come nome, ma ora contengono il tema
   dell'app: fondo chiaro caldo, schede bianche con bordo, niente vetro */
:root,body,.rd{--ios-bg:#F4F5F7;--ios-card:#FFFFFF;--ios-sep:rgba(17,24,39,.09);
--ios-lbl:#111827;--ios-lbl2:#6B7280;--ios-lbl3:#9CA3AF;--ios-hl:rgba(17,24,39,.05);
--ios-blue:var(--a,#2447D6);--t-verde:#43A047;--t-arancio:#F39C12;--t-rosso:#C62828;--t-r:18px;}
.dark,.dark .rd,body.dark{--ios-bg:#111214;--ios-card:#1C1D20;--ios-sep:rgba(255,255,255,.09);
--ios-lbl:#F3F4F6;--ios-lbl2:#9CA3AF;--ios-lbl3:#6B7280;--ios-hl:rgba(255,255,255,.06);}
#pfOv,#scnOv,#hmNew,#hmFg,#edOv,#popOv,#hmStatBar{font-family:inherit!important;}
#pfOv,#scnOv{box-shadow:none!important;}

/* ── la testata unica ── */
.t-hd{position:sticky;top:0;z-index:5;display:flex;align-items:center;gap:12px;
padding:calc(10px + env(safe-area-inset-top,0px)) 16px 12px;background:var(--ios-bg);}
.t-tit{flex:1;min-width:0;margin:0;font-size:24px;font-weight:800;letter-spacing:-.4px;
color:var(--ios-lbl);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;line-height:1.2;}
.t-back,.qback,.pz-x,.pzq-x,.pzg-x,.nm-x,.rg-x,.cx-x,.ip-x,.rq-x,.or-x,.sc-x,.qrun-x,#mgOv .mg-b[title="Esci"]{display:inline-flex!important;align-items:center!important;justify-content:center!important;
flex:0 0 40px;width:40px!important;height:40px!important;min-width:40px!important;min-height:40px!important;
padding:0!important;border-radius:50%!important;border:1.5px solid var(--ios-sep)!important;
background:var(--ios-card)!important;color:var(--ios-lbl)!important;font-size:0!important;
cursor:pointer;box-shadow:none!important;-webkit-tap-highlight-color:transparent;}
.t-back::before,.qback::before,.pz-x::before,.pzq-x::before,.pzg-x::before,.nm-x::before,.rg-x::before,.cx-x::before,.ip-x::before,.rq-x::before,.or-x::before,.sc-x::before,.qrun-x::before,#mgOv .mg-b[title="Esci"]::before{content:'';display:block;width:10px;height:10px;
border-left:2.6px solid currentColor;border-bottom:2.6px solid currentColor;
transform:translateX(2px) rotate(45deg);border-radius:1px;}
.qback svg,.pz-x svg,.pzq-x svg,.pzg-x svg,.nm-x svg,.rg-x svg,.cx-x svg,.ip-x svg,.rq-x svg,.or-x svg,.sc-x svg,.qrun-x svg,#mgOv .mg-b[title="Esci"] svg,.t-back svg{display:none!important;}
.t-back:active,.qback:active,.pz-x:active,.pzq-x:active,.pzg-x:active,.nm-x:active,.rg-x:active,.cx-x:active,.ip-x:active,.rq-x:active,.or-x:active,.sc-x:active,.qrun-x:active,#mgOv .mg-b[title="Esci"]:active{transform:scale(.92);}
.t-info{flex:0 0 38px;width:38px;height:38px;border-radius:50%;border:2px solid var(--a,#2447D6);
background:transparent;color:var(--a,#2447D6);font:italic 700 17px Georgia,'Times New Roman',serif;
cursor:pointer;padding:0;-webkit-tap-highlight-color:transparent;}
.t-info:active{transform:scale(.92);}
.t-info-in{margin-left:auto;}
#tpBack{margin-right:2px;}#tpInfo{margin-left:6px;}
#hmStatBar{margin:0 -16px 12px!important;padding:0!important;background:var(--ios-bg)!important;
backdrop-filter:none!important;-webkit-backdrop-filter:none!important;border:none!important;}
#hmStatBar{display:block!important;}
#hmStatBar .t-hd{position:static;width:100%;box-sizing:border-box;padding-left:10px;padding-right:10px;}

/* ── via lo stile iOS: le liste diventano schede ── */
.pf-big,.pf-nav{display:none!important;}
.pf-body{padding-top:4px!important;}
.pf-sez{font-size:13px!important;font-weight:800!important;letter-spacing:.08em!important;
text-transform:uppercase;color:var(--ios-lbl)!important;margin:6px 18px 10px!important;}
.pf-gr{background:transparent!important;border-radius:0!important;overflow:visible!important;
margin:0 16px 24px!important;display:flex;flex-direction:column;gap:10px;}
.pf-r{background:var(--ios-card)!important;border:1.5px solid var(--ios-sep)!important;
border-radius:var(--t-r)!important;padding:8px 8px 8px 14px!important;min-height:64px!important;
transition:transform .15s ease!important;}
.pf-r:active{background:var(--ios-card)!important;transform:scale(.98)!important;}
.pf-r+.pf-r .pf-txt::before{display:none!important;}
.pf-ic{flex:0 0 42px!important;width:42px!important;height:42px!important;border-radius:12px!important;
font-size:20px!important;margin-right:14px!important;}
.pf-n{font-size:16px!important;font-weight:700!important;letter-spacing:-.2px!important;}
.pf-d,.sc-d{font-size:15px!important;font-weight:600!important;}
.pf-sw{background:var(--ios-gray5,#E5E7EB)!important;}
.pf-sw.on{background:var(--a,#2447D6)!important;}
.pf-r.rosso{border-color:rgba(198,40,40,.35)!important;}
...
/* ── il popup ── */
#popOv{position:fixed;inset:0;z-index:9800;}
.pop-velo{position:absolute;inset:0;background:rgba(0,0,0,.45);opacity:0;transition:opacity .25s;}
#popOv.su .pop-velo{opacity:1;}
.pop-box{position:absolute;left:0;right:0;bottom:0;max-width:560px;margin:0 auto;
background:var(--ios-card);border-radius:24px 24px 0 0;
padding:10px 20px calc(20px + env(safe-area-inset-bottom,0px));text-align:center;
transform:translateY(105%);transition:transform .36s cubic-bezier(.32,.72,0,1);
box-shadow:0 -8px 30px rgba(0,0,0,.18);}
#popOv.su .pop-box{transform:none;}
.pop-grab{width:40px;height:5px;border-radius:999px;background:var(--ios-sep);margin:0 auto 16px;}
.pop-ic{font-size:40px;line-height:1;margin-bottom:10px;}
.pop-t{font-size:20px;font-weight:800;letter-spacing:-.3px;color:var(--ios-lbl);margin-bottom:8px;}
.pop-x{font-size:15.5px;line-height:1.5;color:var(--ios-lbl2);margin:0 0 18px;}
.pop-az{display:flex;flex-direction:column;gap:9px;}
.pop-b{min-height:52px;padding:14px;border-radius:999px;border:none;cursor:pointer;
...
.pop-b:active{transform:scale(.97);}
.pop-b.pieno{background:var(--a,#2447D6);color:#fff;}
...
setTimeout(function(){if(!OP)return;OP.i++;drawOrd();},750);
};
});
}catch(e){}
}
...
/* ═══════════════════════════════════════════════════
   Il conteggio delle piazze in scadenza serve al coach.
   L'interfaccia che stava qui è stata sostituita da piazze.js:
   249 righe rimosse perché irraggiungibili.
   ═══════════════════════════════════════════════════ */
(function(){
'use strict';
...
/* ═══════════════════════════════════════════════════
   TASTO INDIETRO
   Ogni riquadro che si apre lascia un segno nella cronologia:
   premi Indietro e chiudi quello, invece di uscire dall'app.
   Chiudendo col bottone il segno viene tolto.
   ═══════════════════════════════════════════════════ */
(function(){
'use strict';
var PILA=[],ignora=0;
...
try{
var k=-1,i;
for(i=PILA.length-1;i>=0;i--){if(PILA[i].id===id){k=i;break;}}
if(k<0)return;
/* Chiudendo col bottone tolgo solo il segno dalla pila.
   NON tocco la cronologia: due history.go() nello stesso istante
   si sommavano e sfondavano indietro fino a uscire dall'app.
   Resta un passo a vuoto nella cronologia: innocuo, e mai peggio
   di come si comportava prima che ci fosse questa funzione. */
...
function lega(apre,id,chiude){
try{
var _a=window[apre],_c=window[chiude];
if(typeof _a!=='function'||typeof _c!=='function')return false;
window[apre]=function(){
var prima=!!document.getElementById(id);
var r=_a.apply(this,arguments);
if(!prima&&document.getElementById(id))apri(id,function(){window[chiude]();});
return r;
};
window[chiude]=function(){
var prima=!!document.getElementById(id);
var r=_c.apply(this,arguments);
if(prima&&!document.getElementById(id))chiuso(id);
return r;
};
return true;
}catch(e){return false;}
...
setTimeout(aggancia,2200);
setTimeout(aggancia,4500);
})();

/* ═══════════════════════════════════════════════════
   SALVA UNA COPIA / RIPRISTINA
   Scarica un file con tutto quello che hai fatto e lo rimette
   dentro quando serve. È la rete di sicurezza se il telefono
   si perde o la sincronizzazione fa danni.
   ═══════════════════════════════════════════════════ */
(function(){
'use strict';
/* tutto quello che l'app salva in memoria */
var CHIAVI=['routes','coords','qStats','done','qtStats','studyProg','qExamHist',
'prefs','striscia','examDate','targetDate','targetMeta','rSR','rDel','qNotes','rifVie',
...
var d={},n=0;
try{
/* prendo le chiavi note più qualunque altra dell'app */
var viste={};
...
return {dati:d,quante:n};
}

window.nccEsporta=function(){
try{
var r=raccogli();
var pacco={
app:'Prontuario NCC Milano',
versione:(typeof NCC_VER!=='undefined'?NCC_VER:'')||'',
quando:new Date().toISOString(),
chiavi:r.quante,
dati:r.dati
};
var testo=JSON.stringify(pacco);
var nome='ncc-copia-'+new Date().toISOString().slice(0,10)+'.json';
...
try{toast2('\ud83d\udcbe Copia salvata \u00b7 '+r.quante+' voci \u00b7 '+Math.round(testo.length/1024)+' KB',3200);}catch(e){}
try{hap();}catch(e){}
}catch(e){
try{alert('\u26a0\ufe0f Non sono riuscito a creare la copia.');}catch(e2){}
}
};

window.nccRipristina=function(){
try{
var inp=document.getElementById('nccFileIn');
if(!inp){
inp=document.createElement('input');
inp.type='file';inp.accept='.json,application/json';
inp.id='nccFileIn';inp.style.display='none';
...
fr.onload=function(){
try{
var pacco=JSON.parse(String(fr.result||''));
if(!pacco||!pacco.dati||typeof pacco.dati!=='object'){
alert('\u26a0\ufe0f Questo non sembra un file dell\u2019app.');return;}
var n=Object.keys(pacco.dati).length;
var quando=pacco.quando?new Date(pacco.quando).toLocaleString('it-IT'):'data sconosciuta';
if(!confirm('Copia del '+quando+'\n'+n+' voci.\n\n'
+'Questo SOSTITUISCE quello che hai adesso sul dispositivo.\n'
+'Vuoi procedere?'))return;
/* metto da parte lo stato attuale, non si sa mai */
try{
var prima=raccogli();
localStorage.setItem('nccPrimaDelRipristino',JSON.stringify(prima.dati));
}catch(e){}
var messe=0;
Object.keys(pacco.dati).forEach(function(k){
try{localStorage.setItem(k,pacco.dati[k]);messe++;}catch(e){}
});
alert('\u2705 Ripristinate '+messe+' voci su '+n+'.\n\n'
+'L\u2019app si ricarica adesso.');
setTimeout(function(){location.reload();},400);
}catch(e){
try{alert('\u26a0\ufe0f Il file \u00e8 rovinato o non \u00e8 leggibile.');}catch(e2){}
}
};
fr.readAsText(f);
}catch(e){}
...
/* torna allo stato di prima dell'ultimo ripristino */
window.nccAnnullaRipristino=function(){
try{
var v=localStorage.getItem('nccPrimaDelRipristino');
if(!v){alert('Non c\u2019\u00e8 niente da annullare.');return;}
var d=JSON.parse(v);
if(!confirm('Torno com\u2019era prima dell\u2019ultimo ripristino?'))return;
Object.keys(d).forEach(function(k){try{localStorage.setItem(k,d[k]);}catch(e){}});
localStorage.removeItem('nccPrimaDelRipristino');
...
/* ═══════════════════════════════════════════════════
   ZOOM DEI PERCORSI
   La mappa dei percorsi si allargava fino a non far leggere
   più i nomi delle vie. Ora si ferma più vicino.
   ═══════════════════════════════════════════════════ */
(function(){
'use strict';
setTimeout(function(){
...
var _fb=map.flyToBounds,_fit=map.fitBounds;
if(typeof _fb==='function'){
map.flyToBounds=function(b,o){
o=o||{};
if(!o.maxZoom||o.maxZoom<15)o.maxZoom=15;
var r=_fb.call(this,b,o);
var self=this;
setTimeout(function(){try{if(self.getZoom()<14)self.setZoom(14);}catch(e){}},900);
return r;
};
}
...
o=o||{};
if(!o.maxZoom||o.maxZoom<15)o.maxZoom=15;
var r=_fit.call(this,b,o);
try{if(this.getZoom()<14)this.setZoom(14);}catch(e){}
return r;
};
}
}catch(e){}
...
/* ═══════════════════════════════════════════════════
   👁 STREET VIEW ANCHE SUI PERCORSI
   Sulla tappa in cui sei, apre la strada vera.
   ═══════════════════════════════════════════════════ */
(function(){
'use strict';
window.topoStreetView=function(){
try{
if(typeof cur==='undefined'||!cur){toast2('\u26a0\ufe0f Scegli prima un percorso',2200);return;}
var i=(typeof step==='number')?step:0;
var k=cur.id+'_'+i;
var c=(typeof coords!=='undefined'&&coords)?coords[k]:null;
if(!c){
/* se la tappa non ha marker prendo la prima che ce l'ha */
for(var j=0;j<cur.steps.length;j++){
var c2=coords[cur.id+'_'+j];
if(c2){c=c2;i=j;break;}
}
}
if(!c){toast2('\u26a0\ufe0f Nessun marker su questo percorso',2600);return;}
var nome=cur.steps[i]||'';
if(window.nccStreetView)window.nccStreetView(c.lat,c.lon,nome);
else window.open('https://www.google.com/maps/@?api=1&map_action=pano&viewpoint='
+c.lat+','+c.lon,'_blank','noopener');
}catch(e){}
};
/* aggancio: un bottone accanto ai comandi della topografia */
function metti(){
try{
/* fase 4: il nucleo ha gia' il suo Street View (#bSV, arancione).
   Questo era un doppione: due occhi uguali nella stessa barra. */
return;
var f=document.querySelector('#panel .brow');
if(!f)return;
var b=document.createElement('button');
b.id='svBtn';b.className='btn bs';
b.title='Vedi la strada su Google Street View';
b.innerHTML='\ud83d\udc41\ufe0f';
b.onclick=function(){topoStreetView();};
...
/* le domande del quiz: il posto piu' grande in cui cercare */
try{
if(typeof QUIZ_ALL!=='undefined'&&QUIZ_ALL&&QUIZ_ALL.length){
var nd=0;
for(var qi=0;qi<QUIZ_ALL.length&&nd<12;qi++){
var it=QUIZ_ALL[qi];
var tq=norm(it.q),tc=norm((it.choices||[]).join(' '));
if(tq.indexOf(n)>=0||tc.indexOf(n)>=0){
nd++;
(function(it){
...
+'placeholder="Cerca piazza, via, percorso, domanda\u2026">'
...
try{
var tot=0,fatte=0;
try{tot=(typeof LUOGHI!=='undefined'&&LUOGHI&&LUOGHI.length)?LUOGHI.length:0;}catch(e){}
try{
...
aperti=k.length;
var ora=Date.now();
/* la stessa scadenza del resto dell'app: srDue, non un campo .due */
scaduti=k.filter(function(x){try{return srDue(x)<=ora;}catch(e4){return false;}}).length;
...
/* ═══════════════════════════════════════════════════
   ✏️ LA MAPPA — una sola: grande, pulita, Pencil pronta
   · la Pencil disegna, il dito sposta e zooma: insieme,
     senza cambiare modalita'
   · i tratti sono agganciati alla mappa (lat/lng), non allo
     schermo: zoomando o spostando restano sulle vie giuste
   · parte a livello strada, dove i nomi si leggono
   ═══════════════════════════════════════════════════ */
(function(){
'use strict';
...
window.nccMappaPulita=function(){nccMappaGrande();};
...
+'<button class="mg-b" onclick="nccPencilSpess()" title="Spessore" id="mgSp">'+SPESS+'</button>'
...
+'<button class="mg-b mg-pen" id="mgPen" onclick="nccPencilTog()" title="Disegna anche col dito">\u261d\ufe0f</button>'
+'<div class="mg-sp"></div><div class="mg-info" id="mgInfo">\u270f\ufe0f Pencil pronta</div>'
+'</div><div class="mg-area" id="mgArea"><div id="mgMap"></div><canvas id="mgCanvas"></canvas></div>';
document.body.appendChild(o);
try{if(window.nccOvApri)nccOvApri('mgOv',function(){nccMappaGrandeChiudi();});}catch(e){}
colori();
setTimeout(avvia,120);
try{hap();}catch(e){}
}catch(e){}
};

function colori(){
try{var d=document.getElementById('mgColori');if(!d)return;
d.innerHTML=COLORI.map(function(c,i){return '<button class="mg-c'+(i===COL?' on':'')+'" style="background:'+c[0]
+'" onclick="nccPencilColore('+i+')" title="'+c[1]+'"></button>';}).join('');}catch(e){}
}
window.nccPencilColore=function(i){COL=i;colori();try{hap();}catch(e){}};
window.nccPencilSpess=function(){SPESS=(SPESS>=8)?2:SPESS+2;
var b=document.getElementById('mgSp');if(b)b.textContent=String(SPESS);try{hap();}catch(e){}};
...
var c=[45.4642,9.1900];
try{if(typeof cur!=='undefined'&&cur&&typeof coords!=='undefined'){
for(var i=0;i<cur.steps.length;i++){var k=coords[cur.id+'_'+i];
...
try{
CV=document.getElementById('mgCanvas');if(!CV)return;
var a=CV.parentElement.getBoundingClientRect(),r=window.devicePixelRatio||1;
CV.width=Math.round(a.width*r);CV.height=Math.round(a.height*r);
...
/* dal punto salvato al punto sullo schermo, e ritorno */
function aSchermo(q){
try{if(GEO&&q&&q.lat!=null){var p=MG.latLngToContainerPoint({lat:q.lat,lng:q.lng});return {x:p.x,y:p.y};}}catch(e){}
...
function input(){
try{
var area=document.getElementById('mgArea');if(!area||area.__in)return;area.__in=true;
function xy(ev){var r=area.getBoundingClientRect();return {x:ev.clientX-r.left,y:ev.clientY-r.top};}
function disegno(ev){return ev.pointerType==='pen'||(DIS&&ev.pointerType!=='pen');}
...
if(!CORRENTE)return;
ev.preventDefault();ev.stopPropagation();
var q=xy(ev);if(ULT&&Math.abs(q.x-ULT.x)<1&&Math.abs(q.y-ULT.y)<1)return;
CORRENTE.p.push(daSchermo(q.x,q.y));
if(CTX&&ULT){CTX.strokeStyle=CORRENTE.c;CTX.lineWidth=CORRENTE.w;
CTX.beginPath();CTX.moveTo(ULT.x,ULT.y);CTX.lineTo(q.x,q.y);CTX.stroke();}
ULT=q;
},true);
function fine(ev){if(!CORRENTE)return;if(ev){ev.stopPropagation();}
if(CORRENTE.p.length<2)TRATTI.pop();CORRENTE=null;ULT=null;salva();}
area.addEventListener('pointerup',fine,true);
area.addEventListener('pointercancel',fine,true);
/* la Pencil su Safari manda anche i tocchi: Leaflet non deve vederli */
['touchstart','touchmove'].forEach(function(t){
area.addEventListener(t,function(ev){
var s=ev.touches&&ev.touches[0];
if((s&&s.touchType==='stylus')||(DIS&&ev.touches&&ev.touches.length===1)){
...
DIS=!DIS;
var b=document.getElementById('mgPen');if(b)b.classList.toggle('on',DIS);
var i=document.getElementById('mgInfo');
if(i)i.textContent=DIS?'\u261d\ufe0f Disegni col dito':'\u270f\ufe0f Pencil pronta';
try{if(typeof toast2==='function')toast2(DIS?'Disegno anche col dito: la mappa non si sposta':'Il dito sposta la mappa, la Pencil disegna',2400);}catch(e){}
try{hap();}catch(e){}
};
window.nccPencilAnnulla=function(){try{TRATTI.pop();salva();ridisegna();hap();}catch(e){}};
window.nccPencilPulisci=function(){
try{if(TRATTI.length&&!confirm('Cancello tutto quello che hai disegnato?'))return;
TRATTI=[];salva();ridisegna();try{hap();}catch(e){}}catch(e){}
};
...
var interruttori={togDark:1,togSnd:1,togVib:1,togBerlina:1,togSat:1};
if(interruttori[fn]){
window[fn]();
...
/* LUOGHI e' la lista (218); __LUOGHI__ e' diviso per categorie:
   contando le sue chiavi usciva "17/3" */
try{o.luoghiTot=(typeof LUOGHI!=='undefined'&&LUOGHI&&LUOGHI.length)?LUOGHI.length:0;
var sp=(typeof studyProg!=='undefined'&&studyProg)?studyProg:{};
o.luoghi=Math.min(Object.keys(sp).length,o.luoghiTot||Object.keys(sp).length);}catch(e){}
...
if(n.erroriTot>0){
s.push({ic:'\ud83d\udd01',c:'#FF3B30',
t:n.erroriTot+(n.erroriTot===1?' errore da rivedere':' errori da rivedere'),
d:(n.errori?(n.errori+' in scadenza oggi'):'')+(n.errori&&n.peggiore?' \u00b7 ':'')+(n.peggiore?('soprattutto '+n.peggiore):(n.errori?'':'Le domande che hai sbagliato')),
...
bar.innerHTML=nccTestata('Statistiche','nccHmStatEsci()','stat');
...
/* ═══════════════════════════════════════════════════
   📋 LE PAGINE SEZIONE — fase 3
   Quiz, Topografia, Piazze, Norme e tariffe: ognuna una
   pagina iOS con le schede raggruppate. Entrano da destra,
   si chiudono con ‹ Home o trascinando dal bordo.
   ═══════════════════════════════════════════════════ */
(function(){
'use strict';
function L(k,d){try{var v=localStorage.getItem(k);return v==null?d:JSON.parse(v);}catch(e){return d;}}
...
return {'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c];});}
function f(n){return typeof window[n]==='function';}
var C={blu:'#007AFF',verde:'#34C759',rosso:'#FF3B30',arancio:'#FF9500',giallo:'#FFCC00',
indaco:'#5856D6',viola:'#AF52DE',teal:'#30B0C7',rosa:'#FF2D55',grigio:'#8E8E93',menta:'#00C7BE'};

/* ── i conti che servono alle pagine ── */
function conti(){
var o={};
try{var m=studentModel();var s=0,t=0;m.subs.forEach(function(x){t+=x.n||0;s+=Math.round((x.n||0)*(x.m||0)/100);});
o.sai=s;o.tot=t;}catch(e){}
try{o.err=Object.keys(qtStats.err||{}).filter(function(id){return srDue(id)<=Date.now();}).length;}catch(e){o.err=0;}
...
var AZ={};
function az(nome,fn){AZ[nome]=fn;return nome;}

function pagine(){
var n=conti();
function pct(a,b){return b?Math.round(a/b*100):0;}
return {
quiz:{t:'Quiz',c:C.arancio,
...
{ic:'\ud83e\ude79',c:C.rosa,n:'Le pi\u00f9 sbagliate',s:'Quelle che sbagli da sempre',a:az('q7',quiz('qStartHard'))},
{ic:'\ud83d\udd00',c:C.viola,n:'Le confusioni',s:'Quelle che scambi con un\u2019altra',a:az('q8',quiz('qStartConf'))},
{ic:'\ud83e\ude7a',c:C.teal,n:'Test di ritenzione',s:'Reggono ancora quelle che sapevi?',a:az('q9',quiz('qStartRet'))},
{ic:'\ud83d\udd16',c:C.grigio,n:'Segnalibri',s:'Le domande che hai salvato',d:n.bm?String(n.bm):'',a:az('q10',quiz('qStartCat','bm'))}]}
]},
topo:{t:'Topografia',c:C.blu,
...
g:[
{t:'STUDIA',v:[
{ic:'\ud83c\udfb2',c:C.teal,n:'Una piazza a caso',s:'Fra quelle che hai preparato',a:az('p1',function(){pzRandom();})},
{ic:'\ud83d\udd78',c:C.indaco,n:'Mappa a ragno',s:'Le vie una alla volta sulla mappa',a:az('p2',function(){pzRandom(1);})},
{ic:'\u270d\ufe0f',c:C.arancio,n:'Scrivi le vie',s:'A memoria, con i refusi perdonati',a:az('p3',function(){pzScriviCaso();})}]},
{t:'QUIZ',v:[
...
if(nuovo){
requestAnimationFrame(function(){o.classList.add('dentro');});
try{if(window.nccOvApri)nccOvApri('scnOv',function(){nccSezChiudi();});}catch(e){}
bordo(o);
}else{
/* passaggio fra pagine: la nuova arriva da destra */
...
window.nccSezQuiz=function(){nccSez('quiz');};
window.nccSezTopo=function(){nccSez('topo');};
window.nccSezPz=function(){nccSez('pz');};
window.nccSezNorme=function(){nccSez('norme');};

window.nccSezVai=function(nome,resta){
try{
var fn=AZ[nome];if(!fn)return;
try{hap();}catch(e){}
if(resta){fn();return;}
nccSezChiudi(true);
setTimeout(function(){try{fn();}catch(e){}},180);
}catch(e){}
};

/* ── i percorsi senza marker: un tocco e sei sulla mappa a metterli ── */
window.nccSenzaMarker=function(){
try{
var l=senzaMarker();
var corpo='';
if(!l.length){
corpo='<div class="sc-vuoto">\u2705 Tutti i percorsi hanno almeno un marker.</div>';
}else{
corpo='<div class="sc-nota">Tocca un percorso: si apre sulla mappa, poi tocchi una tappa e il punto dove sta.</div>'
+'<div class="pf-gr">';
l.forEach(function(r){
corpo+='<button class="pf-r sc-r" onclick="nccApriPerMarker(\''+String(r.id).replace(/'/g,'')+'\')">'
+'<span class="pf-ic" style="background:'+C.rosso+'">\ud83d\udccd</span>'
+'<span class="pf-txt sc-txt"><span class="sc-col"><span class="pf-n">'+E(r.title)+'</span>'
+'<span class="sc-s">'+r.steps.length+' tappe, nessun marker</span></span></span>'
+'<span class="pf-ch">\u203a</span></button>';
});
corpo+='</div>';
}
pagina('senza','Senza marker ('+l.length+')',corpo,"nccSez('topo')");
}catch(e){}
};
...
'nccApriCerca','nccMappaGrande','openMgr','openStats','openWrong','nccProfilo','nccImportaPercorsi',
'ordinaVie','pzRandom','pzScriviCaso','pzQuizVie','pzQuizInv','nmQuiz','regQuiz'].forEach(function(n){
...
if(typeof tabGo==='function'&&!tabGo.__sc){
var _t=tabGo;tabGo=function(){try{if(document.getElementById('scnOv'))nccSezChiudi(true);}catch(e){}
return _t.apply(this,arguments);};tabGo.__sc=true;}
}catch(e){}
},4100);
})();
...
/* ═══════════════════════════════════════════════════
   📱 PIÙ MAPPA SU IPHONE
   Il pannello partiva allo scatto medio: 30% di mappa e 46% di
   pannello. Ora sul telefono in verticale parte ridotto: solo
   titolo, contatore e bottoni. L'elenco delle vie e' a un
   trascinamento di distanza, con la maniglia.
   Il nucleo lascia scendere il pannello a 140px, ma li' i bottoni
   non ci stanno: l'altezza minima, calcolata sui pezzi veri,
   vince sulla massima e li tiene sempre interi.
   ═══════════════════════════════════════════════════ */
(function(){
'use strict';
function telefono(){return window.innerWidth<700&&window.innerHeight>window.innerWidth;}
function pan(){return document.getElementById('panel');}
function misura(){
try{
var p=pan();if(!p)return 0;
var h=0;
['#pdrag','.phead .ptrow','.phead .psub','.phead .pbw','.pfoot'].forEach(function(s){
var e=p.querySelector(s);if(e)h+=e.getBoundingClientRect().height;});
var cs=getComputedStyle(p);h+=(parseFloat(cs.paddingTop)||0)+(parseFloat(cs.paddingBottom)||0);
var ph=p.querySelector('.phead');
if(ph){var c2=getComputedStyle(ph);h+=(parseFloat(c2.paddingTop)||0)+(parseFloat(c2.paddingBottom)||0)
+(parseFloat(c2.marginTop)||0)+(parseFloat(c2.marginBottom)||0);}
var pf=p.querySelector('.pfoot');
if(pf){var c3=getComputedStyle(pf);h+=(parseFloat(c3.marginTop)||0)+(parseFloat(c3.marginBottom)||0);}
...
var p=pan();if(!p){inCorso=false;return;}
if(!telefono()){p.classList.remove('pnl-mini');if(p.style.minHeight)p.style.minHeight='';inCorso=false;return;}
var mh=parseFloat(p.style.maxHeight||'0');
var mini=mh>0&&mh<=260;
p.classList.toggle('pnl-mini',mini);
if(mini){var v=misura()+'px';if(p.style.minHeight!==v)p.style.minHeight=v;}
else if(p.style.minHeight)p.style.minHeight='';
inCorso=false;
}catch(e){inCorso=false;}
}
window.nccPannelloAggiorna=aggiorna;
function riduci(){
try{
if(!telefono())return;
var p=pan();if(!p)return;
p.style.maxHeight='140px';
aggiorna();
setTimeout(function(){try{mapResizeSoon();}catch(e){try{map.invalidateSize();}catch(e2){}}},80);
setTimeout(function(){try{mapResizeSoon();}catch(e){}},420);
}catch(e){}
}
window.nccPannelloRiduci=riduci;
function osserva(){
try{
var p=pan();if(!p||p.__oss)return;p.__oss=true;
new MutationObserver(function(){aggiorna();}).observe(p,{attributes:true,attributeFilter:['style']});
}catch(e){}
}
setTimeout(function(){
osserva();
try{var _gt=goTopografia;goTopografia=function(){var r=_gt.apply(this,arguments);
setTimeout(function(){osserva();riduci();},260);return r;};}catch(e){}
try{var _sm=setMode;setMode=function(){var r=_sm.apply(this,arguments);setTimeout(aggiorna,60);return r;};}catch(e){}
},2500);
window.addEventListener('resize',function(){setTimeout(aggiorna,120);});
window.addEventListener('orientationchange',function(){setTimeout(aggiorna,300);});
})();
...
+'<button class="ed-b ed-x" onclick="nccEdTogli('+i+')" aria-label="Togli">\u2212</button>'
+'</div>';
});
...
try{
if(!silenzio&&ED&&ED.mod&&!confirm('Esco senza salvare le modifiche?'))return;
chiudi();
}catch(e){chiudi();}
};
function chiudi(){
...
try{
if(qStats[r.id]&&qStats[r.id].wrong){
var ow=qStats[r.id].wrong,nw={};
st.forEach(function(s,j){if(s.o!=null&&ow[s.o])nw[j]=ow[s.o];});
qStats[r.id].wrong=nw;}
}catch(e){}
r.title=tit;r.steps=st.map(function(s){return s.t;});
try{save();}catch(e){}
try{autoSave();}catch(e){}
var aperto=(typeof cur!=='undefined'&&cur&&String(cur.id)===String(r.id));
chiudi();
...
+'<span class="pf-ic" style="background:'+(x.ck?'#FF9500':'#8E8E93')+'">'+(x.ck?'\u26a0\ufe0f':'\u270f\ufe0f')+'</span>'
+'<span class="pf-txt sc-txt"><span class="sc-col"><span class="pf-n">'+E(x.r.title)+'</span>'
+'<span class="sc-s">'+x.r.steps.length+' tappe'+(x.ck?' \u00b7 da controllare':'')+'</span></span></span>'
+'<span class="pf-ch">\u203a</span></button>';
});
corpo+='</div>';
/* la stessa pagina e la stessa testata di tutte le altre */
nccPagina('correggi','Correggi le tappe',corpo,"nccSez('topo')");
}catch(e){}
};
window.nccEdDaElenco=function(id){
try{nccModificaPercorso(id);}catch(e){}
};

/* ── il bottone ✏️ Correggi nel pannello, accanto a Linea ── */
function metti(){
try{
if(document.getElementById('edBtn'))return;
var lb=document.getElementById('lineaBtn');if(!lb||!lb.parentElement)return;
var b=document.createElement('button');
b.id='edBtn';b.type='button';b.className=lb.className;
b.textContent='\u270f\ufe0f Correggi';
b.onclick=function(e){e.stopPropagation();nccModificaPercorso();};
lb.parentElement.insertBefore(b,lb.nextSibling);
}catch(e){}
}
setTimeout(metti,2800);
...
/* ═══════════════════════════════════════════════════
   🎨 FASE 2 — TEMA UNICO, TESTATA UNICA, POPUP
   ═══════════════════════════════════════════════════ */
(function(){
'use strict';
function E(s){return String(s==null?'':s).replace(/[&<>"']/g,function(c){
...
/* ── il popup che sale dal basso, uguale per tutto ── */
window.nccPopup=function(o){
try{
o=o||{};
var v=document.getElementById('popOv');if(v)v.remove();
v=document.createElement('div');v.id='popOv';
var az=(o.azioni&&o.azioni.length)?o.azioni:[{t:'Ho capito',stile:'pieno'}];
var ic=o.icona||'',tx=String(o.testo==null?'':o.testo);
/* se il messaggio comincia con un'emoji, diventa l'icona */
try{var m=tx.match(/^(\p{Extended_Pictographic}\uFE0F?)\s*/u);if(m&&!ic){ic=m[1];tx=tx.slice(m[0].length);}}catch(e){}
var h='<div class="pop-velo"></div><div class="pop-box" role="dialog"><div class="pop-grab"></div>'
+(ic?'<div class="pop-ic">'+ic+'</div>':'')
+(o.titolo?'<div class="pop-t">'+E(o.titolo)+'</div>':'')
+(tx?'<div class="pop-x">'+E(tx).replace(/\n/g,'<br>')+'</div>':'')
+(o.html||'')+'<div class="pop-az">';
az.forEach(function(a,i){h+='<button class="pop-b '+(a.stile||'pieno')+'" data-i="'+i+'">'+E(a.t)+'</button>';});
h+='</div></div>';
v.innerHTML=h;document.body.appendChild(v);
var chiuso=false;
function chiudi(cb){
...
box.addEventListener('touchstart',function(e){y0=e.touches[0].clientY;dy=0;box.style.transition='none';},{passive:true});
box.addEventListener('touchmove',function(e){if(y0===null)return;dy=Math.max(0,e.touches[0].clientY-y0);
...
}catch(e){return {chiudi:function(){}};}
};
window.nccConferma=function(msg,ok,op){
op=op||{};
var rosso=/cancell|elimin|reimpost|azzer|perder|perso|uscire|esci/i.test(String(msg))||op.rosso;
nccPopup({icona:op.icona||(rosso?'\u26a0\ufe0f':'\u2753'),titolo:op.titolo||'',testo:msg,
azioni:[{t:op.si||'Conferma',stile:rosso?'rosso':'pieno',fn:ok},{t:'Annulla',stile:'vuoto',fn:op.no}],annulla:op.no});
};
window.nccChiudiPopup=function(){try{var v=document.getElementById('popOv');if(v)v.remove();}catch(e){}};

/* ── alert(): non aspetta risposta, quindi si sostituisce e basta ── */
var _al=window.alert;
window.alert=function(m){try{nccPopup({testo:String(m==null?'':m),azioni:[{t:'OK',stile:'pieno'}]});}
catch(e){try{_al.call(window,m);}catch(e2){}}};

/* ── confirm(): la funzione gira a vuoto per catturare il suo messaggio,
   poi, se confermi, la rilancio con la risposta gia' data ── */
...
w.__pop=true;window[nome]=w;
}catch(e){}
}
setTimeout(function(){
['qConfirmExit','qFinish','doReset','delRoute','restoreBackup','sdExit','tabGo',
'pzElimina','pzTrovaMarker','nccEdAnnulla','nccImpAggiungi','nccPencilPulisci',
'nccAnnullaRipristino','nccAzzeraErrori','nccRipristina','openRestore'].forEach(avvolgi);
},4400);

/* ── salva e ripristina: due strade vere, non un OK/Annulla che finge ── */
window.nccSalvaCopia=function(){
var az=[{t:'\ud83d\udcf1 Sul telefono, come file',stile:'pieno',fn:function(){try{nccEsporta();}catch(e){}}}];
if(typeof cloudSave==='function')az.push({t:'\u2601\ufe0f Sul cloud',stile:'pieno2',fn:function(){try{cloudSave();}catch(e){}}});
az.push({t:'Annulla',stile:'vuoto'});
nccPopup({icona:'\ud83d\udcbe',titolo:'Salva una copia',testo:'Dove la salvo?',azioni:az});
};
window.nccRiprendiCopia=function(){
var az=[{t:'\ud83d\udcc2 Da un file che hai salvato',stile:'pieno',fn:function(){try{nccRipristina();}catch(e){}}}];
if(typeof restoreBackup==='function')az.push({t:'\ud83d\udee1 Dall\u2019ultimo backup settimanale',stile:'pieno2',fn:function(){try{restoreBackup();}catch(e){}}});
az.push({t:'Annulla',stile:'vuoto'});
nccPopup({icona:'\u21a9\ufe0f',titolo:'Ripristina',testo:'Da dove riprendo i tuoi dati?',azioni:az});
};

/* ── la (i): cosa c'e' in questa pagina ── */
var INFO={
quiz:['\ud83d\udcdd','Quiz','Le domande ufficiali dell\u2019esame. La simulazione \u00e8 identica a quella vera; l\u2019allenamento ti fa studiare con calma; il ripasso ti rimette davanti le domande sbagliate, prima quelle scadute.'],
topo:['\ud83d\uddfa\ufe0f','Topografia','I percorsi di Milano. Studio: vedi tutte le vie. Cieco: sono coperte e le scopri una alla volta. Quiz vie: le scrivi tu a memoria, i refusi non contano.'],
mappa:['\ud83d\uddfa\ufe0f','La mappa dei percorsi','In alto scegli il percorso e la modalit\u00e0: Studio, Cieco o Quiz vie. Trascina in su la maniglia del pannello per vedere l\u2019elenco delle vie.'],
pz:['\ud83d\udd37','Piazze','Le 91 piazze e le vie che vi sboccano. Prima le studi sulla mappa a ragno, poi le scrivi a memoria, poi fai i quiz.'],
norme:['\ud83d\udcdc','Norme e tariffe','Il regolamento comunale, articoli 38-61, e il prontuario delle tariffe: le cose che all\u2019esame si chiedono a memoria.'],
tariffe:['\ud83d\udcd0','Tariffe','Il prontuario: scatti, tariffe fisse, minimi per gli aeroporti.'],
studio:['\ud83d\udccd','Cosa & Dove','I luoghi di Milano con le schede: leggi la scheda, poi rispondi dove si trova.'],
...
nccPopup({icona:i[0],titolo:i[1],testo:i[2],azioni:[{t:'Ho capito',stile:'pieno'}]});
};

/* ── la testata unica: ‹ · titolo · (i) ── */
window.nccTestata=function(titolo,indietro,info){
return '<div class="t-hd"><button class="t-back" onclick="'+(indietro||'goHome()')+'" aria-label="Indietro"></button>'
+'<h1 class="t-tit">'+E(titolo)+'</h1>'
+(info?'<button class="t-info" onclick="nccInfo(\''+info+'\')" aria-label="Informazioni">i</button>':'')
+'</div>';
};
window.nccEmoSez={'ESAME':'\ud83c\udfc1','ALLENAMENTO':'\ud83c\udfaf','RIPASSO':'\ud83d\udd01','MAPPA':'\ud83d\uddfa\ufe0f',
'STUDIA':'\ud83d\udcd6','I TUOI PERCORSI':'\ud83d\udccb','QUIZ':'\u2753','ELENCO':'\ud83d\udcda','NORME':'\ud83d\udcdc',
'TARIFFE':'\ud83d\udcb6','IL MIO ESAME':'\ud83c\udfaf','I MIEI DATI':'\ud83d\udcbe','IMPOSTAZIONI':'\u2699\ufe0f'};

/* ── la (i) e il ‹ anche nelle schermate che non ho scritto io ── */
var PRESE=[['#cxOv .cx-x','cerca'],['#qBack','quiz'],['#studyApp .qback','studio'],['#pzOv .pz-x','pz'],['#nmOv .nm-x','norme'],['#rgOv .rg-x','tariffe']];
function inietta(){
try{
...
/* la schermata mappa: ‹ al posto della casetta, (i) in fondo alla barra */
var h=document.getElementById('homeTopBtn');
if(h&&h.parentElement&&!document.getElementById('tpBack')){
var bk=document.createElement('button');bk.id='tpBack';bk.className='t-back';bk.setAttribute('aria-label','Indietro');
bk.onclick=function(){try{goHome();}catch(e){}};
h.parentElement.insertBefore(bk,h);
var inf=document.createElement('button');inf.id='tpInfo';inf.className='t-info';inf.textContent='i';
inf.setAttribute('aria-label','Informazioni');inf.onclick=function(){nccInfo('mappa');};
h.parentElement.appendChild(inf);
}
}catch(e){}
}
...
function segui(){
try{if(!mq||localStorage.getItem('dark')!==null)return;
if(typeof dark!=='undefined'&&dark===mq.matches)return;
dark=mq.matches;if(typeof applyDark==='function')applyDark();}catch(e){}
}
